...
describe('NATURAL_MIDI_NUMBERS', () => {
  test('does not contain out-of-range numbers', () => {
    expect(MidiNumbers.NATURAL_MIDI_NUMBERS).not.toContain(11)
    expect(MidiNumbers.NATURAL_MIDI_NUMBERS).not.toContain(128)
  })
  test('contains only natural note numbers', () => {
    expect(MidiNumbers.NATURAL_MIDI_NUMBERS).toContain(74)
    expect(MidiNumbers.NATURAL_MIDI_NUMBERS).not.toContain(75)
  })
})
